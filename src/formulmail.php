...
try{
	...
	$mail->setFrom('pwaksmann@gmail.com', 'Patrick W sender');
...
<body>
	...
	<pre>
		...
		<br>
		<p> <font size="2" >
			<?php echo "Vous êtes : ";?></font>
			<font size="3" >	 
			<?php print $_POST["txt_prof"];?></font>
		</p>
		<br>
		<p class="b">	<?php echo "Jours disponibles dans la semaine : ";?></p>
		<p class="ab">
			<?php
			 foreach ($_POST[ck_date] as $value) {
